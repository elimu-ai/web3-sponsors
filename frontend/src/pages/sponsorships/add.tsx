    ...
    if (!writeIsPending) {
      ...
      return (
        <>
          ...
          <div className="bg-purple-950 mt-4 p-4 rounded-lg text-center">
  ...
  if (txIsLoading) {
    return (
      <>
        ...
        <div className="bg-purple-900 mt-4 p-4 rounded-lg text-center">
    ...
    return (
      <div className="bg-purple-800 mt-4 p-4 rounded-lg text-center">
        🎉 Your sponsorship has been added successfully! 🎉<br />
        <Link href={`https://sepolia.etherscan.io/tx/${writeHash}`} target='_blank' className="text-purple-300">
          View on Etherscan ↗
        </Link>
      </div>
    )
