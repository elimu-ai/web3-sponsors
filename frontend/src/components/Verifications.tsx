...
import { abi as abi_distribution_verifier } from "../../../backend/ignition/deployments/sepolia_v0-9-7/artifacts/DistributionVerifierModule#DistributionVerifier.json";
